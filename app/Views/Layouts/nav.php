        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="/">
                    <img src="<?= base_url('assets/images/logo/logobcolor.png') ?>" alt="Sistema de Donaciones" class="img-fluid" style="max-width: 50px;">
                </a>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <li><a class="dropdown-item" href="<?php echo base_url('/Voluntario/voluntario_perfil') ?>">Mi Perfil</a> </li>
